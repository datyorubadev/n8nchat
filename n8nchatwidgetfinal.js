...
(function() {
    ...
    async function submitMessage(messageText) {
        ...
        // Clear attachment previews immediately when send is clicked
        clearAttachments();
        ...
        if (currentAttachments.length > 0) {
            currentAttachments.forEach(file => {
                if (isImageFile(file)) {
                    ...
                    imageMessage.className = 'message-row';
                    ...
                    imageMessage.appendChild(imageBubble);
                    messagesContainer.appendChild(imageMessage);
                } else {
                    const fileMessage = document.createElement('div');
                    fileMessage.className = 'message-row';
                    ...
                    fileMessage.appendChild(fileBubble);
